...
public final class LocatorHelper {
    ...
    public static WebElement quietlyFindElement(WebDriver driver, By locator) {
    ...
    public static WebElement getElementFromDiv(WebDriver driver, String containerId, String elementTag){
        return getElementFromDiv(driver, containerId, elementTag, timeout);
    }
}
